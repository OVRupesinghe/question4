...
for epoch in range(epochs):
    ...
    n_neighbors = initial_neighbors + epoch  

    print(f"Epoch {epoch + 1}/{epochs} with {num_clusters} clusters and {n_neighbors} neighbors")
    ...
    # Train kNN classifier with changing number of neighbors
